    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1cCtgf6loZ4dr5glyWu2dZkdYPUtZ8CBl/view?usp=sharing"
            target="_blank"
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          ...
          >
            <img
              src={profileImage}
              alt="MrutyunjayMahanta"
              className="w-full h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,2.5)]"
            />
          </Tilt>
        </div>
      </div>
